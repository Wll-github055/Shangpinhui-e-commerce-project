            ...
            <tr v-for="(good,index) in order.orderDetailList" :key="good.id">
              <td width="60%">
                <div class="typographic">
                  <img :src="good.imgUrl" style="width:15%;" />
                  <a href="#" class="block-text" style="width:70%">{{good.skuName}}</a>
                  <span style="width:5%">x{{good.skuNum}}</span>
                  <a href="#" class="service" style="width:10%">售后申请</a>
                </div>
              </td>
